            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    Price_MaxValue = table.Column<int>(type: "integer", nullable: false),
                    Price_MinValue = table.Column<int>(type: "integer", nullable: false),
                    Price_Format = table.Column<string>(type: "text", nullable: false),
                    Time_Minutes = table.Column<int>(type: "integer", nullable: false),
                    Time_Seconds = table.Column<int>(type: "integer", nullable: false),
